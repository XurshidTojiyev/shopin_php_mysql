          ...
          <div class="card shadow-sm">
			...
			<b class="card-text" style="font-size: 30px;"><?=$data['title'];?></b>
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a href='delete.php?id=<?=$data["id"]?>' type="button" class="btn btn-outline-danger">Delete</a>
					<a href='favourite.php?id=<?=$data["id"]?>' type="button" class="btn btn-outline-primary">Add to Favourites</a>
                </div>
              </div>
            </div>
          </div>
